...
inline constexpr std::array<TrackControlPoint, 121> kSpaControlPoints = {{
    ...
    {-212.0f, -31.0f},  {-207.0f, -14.0f},  {-198.0f, 2.0f},    {-186.0f, 16.0f},
    {-171.0f, 27.0f},   {-154.0f, 34.0f},   {-137.0f, 35.0f},   {-123.0f, 37.0f},
    {-119.0f, 39.0f},   {-108.0f, 45.0f},   {-98.0f, 53.0f},    {-85.0f, 66.0f},
